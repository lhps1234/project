...
import com.example.board.model.ReviewWriteForm;
...
public class BoardController {
    ...
    public String read(@RequestParam Long board_id,
        ...
        Board board = reviewService.readBoard(board_id);
        ...
        // 첨부파일을 찾는다.
        AttachedFile attachedFile = reviewService.findFileByBoardId(board_id);
    ...
    public String updateForm(@SessionAttribute(value = "loginMember", required = false) Member loginMember,
        ...
        Board board = reviewService.findBoard(board_id);
    ...
    public String update(@SessionAttribute(value = "loginMember", required = false) Member loginMember,
        ...
        reviewService.updateBoard(board, updateBoard.isFileRemoved(), file);
    ...
    public String remove(@SessionAttribute(value = "loginMember", required = false) Member loginMember,
        ...
        // 게시글을 삭제한다.
        reviewService.removeBoard(board_id);
    ...
    public ResponseEntity<Resource> download(@PathVariable Long id) throws MalformedURLException {
        AttachedFile attachedFile = reviewService.findFileByAttachedFileId(id);
